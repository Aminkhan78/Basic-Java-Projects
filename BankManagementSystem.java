...
class SavingAccount extends Bank {
    ...
    int Deposit;
    int Withdraw;
    SavingAccount(String name, int age, int Balance)
    {
        super(name, age);
...
class CurrentAccount extends Bank {
    ...
    int Deposit;
    int Withdraw;
    CurrentAccount(String name, int age, int Balance)
    {
        super(name, age);
        this.Balance = Balance;
            ...
            if (Choice == 1) {
                ...
                switch (Type) {
                    case 1:
                        ...
                        CurrentIndex++;
                        AllAccounts[CurrentIndex] = new SavingAccount(Name, Age, Balance);
                        ...
                        CurrentIndex++;
                        AllAccounts[CurrentIndex] = new CurrentAccount(Name, Age, Balance1);
                        AllAccounts[CurrentIndex].display();
                        break;
                    default:
